...
OBJ = "obj"
PASSED = "😇 Passed"
PROCESSED_SELECTOR = "processed_selector"
...
TIMEOUT = "timeout"
UNIQUE = "unique"
UNIQUE_TEXT_VALUES = "unique_text_values"
...
# Path to a Chrome user-data-dir (custom browser profile). When set,
# the Chrome driver launches with --user-data-dir=<path> so the profile's
# cookies, sessions, and saved logins are reused. Required for any flow
# that needs to act as a specific human user (e.g. Gmail flows operating
# in Akien's Igor browser profile, not the default).
